 ...
 * Beschreibung der Klasse: UserView
...
public class UserView extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        final URL fxmlURL = this.getClass().getResource("/userclient.fxml");
        final FXMLLoader loader = new FXMLLoader(fxmlURL);
        loader.setController(new Controller(primaryStage));
        final Parent root = loader.load();

        primaryStage.setTitle("Userclient - Daniels dolle Datenbankapplication");
